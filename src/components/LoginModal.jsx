  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (activeTab === 'login') {
        ...
        console.log('From LoginModal, response: ', result)
        ...
        if (response.ok) {
          ...
          loginState(true)
          closeModal()
          router.refresh() // Refresh to get updated server state
        } else {
          console.log("Entered")
              ...
              <div className="text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {activeTab === 'signup' && (
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-4 bg-zinc-700 text-white border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                        required
                      />
                    </div>
                  )}
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-4 bg-zinc-700 text-white border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                      required
                      minLength="6"
                    />
                    <button
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50"
                  >
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    <button className="flex items-center justify-center px-4 py-3 border border-gray-600 rounded-xl hover:bg-zinc-700 transition-colors">
